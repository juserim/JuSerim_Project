		...
		<div class="row tm-mb-90 tm-gallery">
			<c:forEach var="boardList" items="${boardList}" >
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					<figure class="effect-ming tm-video-item"  style="min-height: 300px;	">
						<c:if test="${boardList.savedfilename == null or boardList.savedfilename == '' }">
							<img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/No_sign.svg" alt="Image" class="img-fluid" style="margin:auto">
						</c:if>
						<c:if test="${boardList.savedfilename != null and boardList.savedfilename != '' }">
						<img src="/endb/resources/upload-files/${boardList.savedfilename}" alt="Image" class="img-fluid" style="margin:auto">
						</c:if>
						<figcaption
								class="d-flex align-items-center justify-content-center">
							<h2>${boardList.title}</h2>
							<a href=/endb/board/detail?&pageNo=1&boardno=${boardList.room_id}>View more</a>
						</figcaption>
					</figure>
