...
@WebServlet("/showmydog/showmydogdownload.action")
public class ShowMyDogDownloadServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ShowMyDogBoardAttach boardAttach = boardService.findBoardAttachByAttachNo(attachNo);		
