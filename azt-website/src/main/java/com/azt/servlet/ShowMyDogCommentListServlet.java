...
@WebServlet(urlPatterns = { "/showmydog/comment-list.action" })
public class ShowMyDogCommentListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<ShowMyDogBoardComment> comments = boardService.findCommentsByBoardNo(boardNo);
		...
		RequestDispatcher dispatcher = 
				req.getRequestDispatcher("/WEB-INF/views/showmydog/showmydogcomment.jsp");
