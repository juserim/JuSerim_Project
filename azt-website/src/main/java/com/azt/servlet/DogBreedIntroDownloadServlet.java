...
@WebServlet("/dogbreedintro/dogbreedintrodownload.action")
public class DogBreedIntroDownloadServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		DogBreedIntroAttach boardAttach = boardService.findBoardAttachByAttachNo(attachNo);		
