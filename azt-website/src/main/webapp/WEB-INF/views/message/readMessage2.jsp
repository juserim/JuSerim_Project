                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <h3 class="mb-0"><%=message.getReceiver()%>님에게 보낸 메세지입니다.</h3>
                      <small class="text-muted float-end">Read Message</small>
                    </div>
                    <div class="card-body">
                      
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">메세지 발신일</label>
                          <%=message.getSendDate() %>                    
                        </div>                     
                        ...
                        <a href="sendMessage.action" class="btn btn-primary">Go to Message</a>
